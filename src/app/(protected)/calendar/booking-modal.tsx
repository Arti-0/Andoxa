    ...
    <>
      ...
      >
        ...
        <div style={{ padding: "18px 22px 16px", borderBottom: "1px solid #EDF1F5", display: "flex", alignItems: "center", justifyContent: "space-between" }}>
          <div>
            <h2 style={{ fontSize: 16, fontWeight: 600, color: "#0F172A", letterSpacing: "-0.01em" }}>Personnaliser la page de booking</h2>
            <div style={{ fontSize: 11.5, color: "#64748B", marginTop: 2 }}>Visible aux personnes qui réservent un RDV avec vous</div>
          </div>
        ...
        <div style={{ flex: 1, overflowY: "auto", padding: "18px 22px" }}>
          {isLoading ? (
            <div style={{ padding: "24px 0", textAlign: "center", fontSize: 13, color: "#94A3B8" }}>Chargement…</div>
          ) : (
            <>
                  ...
                  {SLOT_OPTIONS.map((m) => {
                    ...
                    return (
                      <button
                        ...
                        style={{ padding: "6px 14px", background: active ? "#E8F0FD" : "#fff", color: active ? "#0052D9" : "#64748B", border: `1px solid ${active ? "#0052D9" : "#E2E8F0"}`, borderRadius: 7, fontSize: 12, fontWeight: 500, cursor: "pointer", fontFamily: "inherit" }}
                      >
                        {m} min
                      </button>
                    );
  ...
  return (
    <div style={{ marginBottom: 16 }}>
      <div style={{ display: "flex", alignItems: "baseline", gap: 6, marginBottom: 6 }}>
        <label style={{ fontSize: 11.5, fontWeight: 500, color: "#475569" }}>{label}</label>
