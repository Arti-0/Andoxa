            ...
            {labels.map((label, i) => {
                ...
                return (
                    ...
                    >
                        ...
                        {idx < labels.length && (
                            <span
                                className="ml-1 h-px w-6 bg-border"
                                aria-hidden
                            />
                        )}
                    </button>
...
export function CreateCampaignModal({
    ...
    const previewSource = selectionMode
        ? initialPreviewProspect
        : sampleProspect;
    const previewProspect: ProspectForVariables = previewSource?.full_name
        ? previewSource
        : FALLBACK_PREVIEW_PROSPECT;
    ...
    const handleAttachmentSelect = async (file: File | null) => {
        ...
        try {
            const uploaded = await uploadMessagerieAttachment(
                file,
                workspaceId
            );
            if (!uploaded) {
    ...
    const usesNote =
        (type === 'invitation_only' || type === 'invitation_message') &&
        hasNote;
    const usesMessage =
            ...
            <DialogContent className="max-h-[88vh] gap-0 overflow-hidden p-0 sm:max-w-3xl">
                <DialogHeader className="px-6 pt-5 pb-3">
                    ...
                    <DialogDescription>
                        ...
                        {step === 2 &&
                            'Sélectionnez la séquence et donnez-lui un nom.'}
                        {step === 3 &&
                            'Rédigez votre message — les variables sont remplacées par les données du prospect.'}
                        {step === 4 &&
                            'Vérifiez les détails puis lancez la campagne.'}
                    </DialogDescription>
                </DialogHeader>
                ...
                <DialogFooter className="flex flex-row items-center justify-between gap-2 border-t bg-muted/30 px-6 py-3 sm:flex-row sm:justify-between">
                    <div className="text-xs text-muted-foreground">
                        Étape{' '}
                        <strong className="text-foreground">{step}</strong> sur
                        4
                    </div>
                        ...
                        {step < 4 && (
                            <Button
                                ...
                                disabled={
                                    ...
                                    (step === 2 && !step2Valid) ||
                                    (step === 3 &&
                                        (!step3Valid || attachmentUploading))
                                }
                            >
                                Continuer
                ...
                <div className="flex items-center gap-3 rounded-md border bg-[var(--brand-blue-tint)] px-4 py-3">
                    ...
                    <div className="text-sm">
                        <div className="font-medium">
                            {selectionCount} prospect
                            {selectionCount > 1 ? 's' : ''} sélectionné
                            {selectionCount > 1 ? 's' : ''}
                        </div>
                        ...
                        {bdds.map((b) => {
                            ...
                            return (
                                ...
                                >
                                    ...
                                    {active && (
                                        <Check className="size-4 text-[var(--brand-blue)]" />
                                    )}
                                </button>
                            );
                        })}
            ...
            <div className="space-y-4">
                        ...
                        {noteActive ? (
                            <>
                                ...
                                <Textarea
                                    ...
                                    onChange={(e) =>
                                        setInvitationNote(e.target.value)
                                    }
                ...
                {showMessage && (
                    <div className="rounded-lg border p-4">
                        ...
                        <div className="mt-1 flex items-center justify-between">
                            <span className="text-[11px] text-muted-foreground">
                                Le message part en texte brut (sans mise en
                                forme).
                            </span>
                            <span
                                className={cn(
    ...
    return (
        <div className="space-y-4">
                ...
                <RecapCard label="Cible">
                    {selectionMode ? (
                        ...
                        <>
                            ...
                            <div className="text-[11.5px] text-muted-foreground">
                                {bdd?.prospect_count ?? 0} prospects dans la
                                liste
                            </div>
                        </>
                    )}
                ...
                <div className="rounded-md border border-[var(--brand-blue)]/30 bg-[var(--brand-blue-tint)] px-3 py-2.5 text-[12px] leading-relaxed text-foreground">
                    {usesNote ? (
                        <>
                            ...
                            La note ci-dessus part avec l&apos;invitation ; le
                            message ci-dessous est envoyé dès que le prospect
                        ...
                        <>
                            ...
                            Invitation sans note d&apos;abord, puis le message
                            ci-dessous part dès l&apos;acceptation.
                        </>
                    )}
                </div>
            )}
            ...
            <div className="rounded-md border border-amber-300 bg-amber-50 px-3 py-2.5 text-[12px] leading-relaxed text-amber-900">
                ...
                quotas réels dépendent de votre compte LinkedIn et de votre
                activité récente. Andoxa respecte les limites pour protéger
                votre compte.
            </div>
        </div>
    );
