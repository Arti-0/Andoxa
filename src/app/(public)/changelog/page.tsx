    ...
    },
    {
        ...
        features: [
            ...
            },
            {
                ...
                description:
                    'Tableaux de bord détaillés avec messages envoyés, taux de réponse et de conversion en temps réel.',
            },
            {
                type: 'fix',
                title: 'Délivrabilité',
                            ...
                            <ul className="space-y-3">
                                {entry.features.map((feature, fi) => (
                                    <li key={fi} className="flex gap-3 text-sm">
                                        <span className="shrink-0 mt-0.5">{getFeatureIcon(feature.type)}</span>
                                        <div>
                                            <span className={cn(
                                                'inline-block rounded-full px-2 py-0.5 text-[11px] font-medium mr-2',
