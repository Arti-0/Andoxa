...
const faqItems: FAQItem[] = [
    {
        id: '1',
        question:
            'Comment optimiser le taux de réponse de mes campagnes LinkedIn ?',
        answer: "Le taux de réponse LinkedIn dépend de plusieurs facteurs clés. D'abord, la qualité de votre base de données : utilisez le scoring pour cibler les prospects les plus qualifiés (grade A et B). Ensuite, personnalisez vos messages avec les variables dynamiques (nom, entreprise, poste) pour créer un sentiment de connexion. Le timing est également crucial : évitez les envois le lundi matin et le vendredi après-midi. Respectez les limites d'envoi LinkedIn pour éviter les restrictions. Andoxa vous permet de créer plusieurs variantes de messages et de suivre les performances en temps réel pour identifier ce qui fonctionne le mieux.",
        category: 'campaigns',
        tags: ['optimisation', 'LinkedIn', 'personnalisation'],
    },
    {
        id: '2',
        question:
            'Quelle est la différence entre le scoring automatique et manuel ?',
        answer: "Le scoring automatique analyse chaque prospect lors de l'import ou de l'enrichissement selon 4 critères : l'entreprise (taille, secteur d'activité), le contact (poste, rôle décisionnel), la présence digitale (LinkedIn, email valide, site web) et l'alignement avec les besoins d'une Junior-Entreprise. Le système attribue une note de 0 à 100 et un grade (A, B, C, D). Le scoring manuel vous permet de relancer l'analyse pour des prospects spécifiques, utile après un enrichissement ou une mise à jour des données. Les deux méthodes utilisent le même algorithme IA, mais le manuel vous donne plus de contrôle sur le moment de l'analyse.",
        category: 'scoring',
    ...
    },
    {
        ...
        answer: "Pour gérer efficacement un grand volume, structurez vos données avec des BDD (Bases de données) par source, campagne ou projet. Utilisez les filtres combinés (statut, responsable, recherche) pour segmenter rapidement. Le scoring vous aide à prioriser : concentrez-vous d'abord sur les prospects A et B. L'enrichissement automatique complète les données manquantes (email, téléphone, LinkedIn) pour maximiser vos chances de contact. Enfin, utilisez les campagnes LinkedIn pour automatiser la communication initiale et qualifier les prospects intéressés avant un contact direct ou une session d'appels.",
        category: 'prospects',
    ...
    },
    {
        id: '8',
        question:
            "Quelle stratégie d'envoi pour maximiser les réponses LinkedIn ?",
        answer: "La stratégie d'envoi optimale combine timing, segmentation et personnalisation. Envoyez vos messages le mardi, mercredi ou jeudi entre 9h et 11h ou 14h et 16h pour maximiser les réponses. Évitez les lundis matin (boîte saturée) et vendredis après-midi (week-end imminent). Segmentez votre audience par score : créez des campagnes différentes pour les prospects A/B (plus qualifiés, messages plus directs) et C/D (nurturing, éducation). Personnalisez chaque message avec les variables dynamiques : utilisez le nom, l'entreprise, le poste pour créer un sentiment de connexion. Respectez les limites d'envoi LinkedIn : Andoxa applique des délais entre les envois pour rester sous les plafonds imposés par la plateforme.",
        category: 'campaigns',
    ...
    },
    {
        id: '11',
        question:
            "Qu'est-ce qui différencie un prospect grade A d'un grade D ?",
        answer: "Le grade A représente les prospects les plus qualifiés : entreprises de taille moyenne à grande (50-500 employés), contacts avec rôle décisionnel (CEO, Directeur, Responsable), présence digitale complète (LinkedIn, email valide, site web professionnel), et secteur aligné avec les services d'une Junior-Entreprise (tech, conseil, marketing). À l'inverse, un grade D a des données incomplètes, un contact sans rôle décisionnel clair, une présence digitale faible, ou un secteur peu aligné. Le scoring combine ces 4 critères avec des poids différents : l'alignement secteur et le rôle décisionnel ont plus de poids que la simple présence d'un email. Un prospect A a typiquement un score > 75, un B entre 50-75, un C entre 25-50, et un D < 25. Concentrez vos efforts sur les A et B pour maximiser votre taux de conversion.",
        category: 'scoring',
        tags: ['qualification', 'grades', 'scoring'],
    },
    {
        id: '12',
        question: 'Comment éviter les restrictions LinkedIn sur les envois ?',
        answer: "LinkedIn impose des limites strictes sur le nombre d'invitations et de messages par jour. Andoxa vous aide à rester en dessous de ces plafonds grâce à des contrôles configurables : taille des batchs et délais entre les envois. Utilisez le mode batch pour les campagnes volumineuses : les messages sont envoyés par groupes avec une pause entre chaque batch. Assurez-vous que vos prospects ont un profil LinkedIn valide avant l'envoi. Personnalisez vos messages pour éviter d'être signalés comme spam. Surveillez le statut de vos campagnes : les erreurs (compte restreint, prospect inaccessible) sont visibles dans le détail de la campagne pour que vous puissiez ajuster votre stratégie.",
        category: 'campaigns',
        tags: ['LinkedIn', 'rate limits', 'bonnes pratiques'],
    },
];
                ...
                <div className="space-y-12">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-12">
                        ...
                        <Card className="border-slate-200 dark:border-slate-700">
                            <CardHeader>
                                ...
                                <CardDescription className="text-slate-600 dark:text-slate-400">
                                    Découvrez comment Andoxa peut s&apos;adapter
                    ...
                    <Card className="border-slate-200 dark:border-slate-700 bg-slate-50 dark:bg-slate-900/50">
                        <CardHeader>
                            ...
                            <CardDescription className="text-slate-600 dark:text-slate-400">
                                Explorez nos guides et documentation pour aller
                                plus loin
                            </CardDescription>
                        </CardHeader>
                        <CardContent>
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                ...
                                <Link
                                    ...
                                    className="flex items-center gap-3 p-4 rounded-lg border border-slate-200 dark:border-slate-700 hover:border-blue-500 hover:bg-white dark:hover:bg-slate-800 transition-all"
                                >
                                    <Settings className="h-5 w-5 text-blue-600 dark:text-blue-400 shrink-0" />
                                    <div>
                                        <div className="font-medium text-slate-900 dark:text-white">
                                            Tarifs et plans
                                        </div>
                                        <div className="text-sm text-slate-600 dark:text-slate-400">
                                            Découvrez nos offres et choisissez
                                            votre plan
                                        </div>
                                    </div>
                                </Link>
