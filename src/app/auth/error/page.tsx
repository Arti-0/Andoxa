...
export default async function AuthErrorPage({
    ...
    const raw =
        params.error || params.reason || "Une erreur inattendue s'est produite";
                            ...
                            <Alert className="mb-6 bg-blue-50 dark:bg-blue-950/20 border-blue-200 dark:border-blue-800">
                                <AlertDescription className="text-sm text-blue-900 dark:text-blue-100">
                                    ...
                                    <ul className="list-disc list-inside space-y-1 text-left ml-2">
                                        <li>
                                            Vérifiez que vous avez cliqué sur le
                                            bon lien dans votre email
                                        </li>
                                        <li>
                                            Le lien peut avoir expiré (valide 60
                                            minutes)
                                        </li>
                                        <li>
                                            Assurez-vous de copier le lien
                                            complet si vous l&apos;avez collé
                                            manuellement
                                        </li>
                                        <li>
                                            Vous pouvez demander un nouvel email
                        ...
                        {isInvalidLink && (
                            <>
                                ...
                                <p className="text-xs text-center text-muted-foreground">
                                    Si votre compte est déjà confirmé, vous
                                    pouvez vous connecter directement.
                                </p>
                            </>
                        )}
                        {!isInvalidLink && (
