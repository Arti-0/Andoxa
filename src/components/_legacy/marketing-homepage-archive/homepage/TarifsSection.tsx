  ...
  const plans = [
    {
      ...
      monthly: PRICING_CONFIG.solo.monthly,
      annual: PRICING_CONFIG.solo.annual,
    },
    {
      name: "Pro",
      planId: "team" as const,
      monthly: PRICING_CONFIG.team.monthly,
      annual: PRICING_CONFIG.team.annual,
      isRecommended: true,
    },
    {
      name: "Business",
      planId: "custom" as const,
      monthly: PRICING_CONFIG.custom.monthly,
      annual: PRICING_CONFIG.custom.annual,
    },
  ];
