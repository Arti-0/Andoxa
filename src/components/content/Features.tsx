...
const stats = [
  {
    name: "Gain de temps moyen sur les tâches commerciales",
    value: "30%",
  },
  {
    name: "Augmentation du taux de conversion des leads",
    value: "+40%",
  },
  {
    name: "Sécurisé & hébergé en France",
    value: "100%",
  },
];
...
export default function Features() {
  return (
    ...
    >
      <Badge>Rapidité sans limite</Badge>
      <h2
        id="features-title"
        className="mt-2 inline-block bg-gradient-to-br from-gray-900 to-gray-800 bg-clip-text py-2 text-4xl font-bold tracking-tighter text-transparent sm:text-6xl md:text-6xl dark:from-gray-50 dark:to-gray-300"
      >
        Optimisé pour aller vite, sans jamais lâcher
      </h2>
      <p className="mt-6 max-w-3xl text-lg leading-7 text-gray-600 dark:text-gray-400">
        L’architecture d’Andoxa évite les points de friction classiques des outils traditionnels, pour garantir une expérience fluide et sans interruption.
        Ce design robuste maximise la fiabilité, la sécurité et la productivité, tout en réduisant drastiquement les risques d’erreurs ou de perte de données.
      </p>
