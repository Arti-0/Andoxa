                ...
                {expanded && (
                    <div className="space-y-4 rounded-lg border bg-zinc-50/50 p-4 dark:bg-black/20">
                        <div className="flex flex-wrap gap-2">
                            ...
                            >
                                <ExternalLink className="size-3.5" /> Chrome /
                                Edge
                            </Link>
                            <Link
                                href={firefoxUrl}
                        ...
                        <ol className="list-decimal space-y-2 pl-5 text-sm text-zinc-500 dark:text-zinc-400">
                            <li>
                                Installez l&apos;extension depuis le store de
                                votre navigateur (ou chargez-la en mode
                                développeur).
                            </li>
                            <li>
                                Ouvrez un profil LinkedIn, puis cliquez sur
                                l&apos;icône Andoxa pour ouvrir le panneau.
                            </li>
                            <li>
                                Collez votre UUID ci-dessus, choisissez une
                                liste, et envoyez vos prospects sur Andoxa.
                            </li>
                        </ol>
                    </div>
                )}
