...
/**
 * Draws an SVG path from one element to another within a shared container,
 * with an animated linear gradient travelling along it. Recomputes on resize.
 */
...
export function AnimatedBeam({
  ...
  pathWidth = 2,
  pathOpacity = 0.18,
  gradientStartColor = "#0052D9",
  gradientStopColor = "#1A6AFF",
  startXOffset = 0,
  startYOffset = 0,
  endXOffset = 0,
  endYOffset = 0,
